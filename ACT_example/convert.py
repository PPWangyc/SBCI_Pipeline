...
OUTPUT_BIDS_PATH = os.path.join('/scratch/tbaran2_lab/ACT_BIDS_UMN')
session='01'
dicom_dirs = get_folder_list(os.path.join(ACT_PATH, 'UMN'))
...
for dicom_dir in dicom_dirs:
    ...
    dicom_dir_path = os.path.join(ACT_PATH, 'UMN', dicom_dir)
