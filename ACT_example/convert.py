...
OUTPUT_BIDS_PATH = os.path.join('/scratch/tbaran2_lab/ACT_BIDS_ASU')
session='01'
dicom_dirs = get_folder_list(os.path.join(ACT_PATH, 'ses-01', 'ASU'))
...
for dicom_dir in dicom_dirs:
    ...
    dicom_dir_path = os.path.join(ACT_PATH, 'ses-01', 'ASU', dicom_dir)
